...
export const OfficialLetterhead: React.FC<OfficialLetterheadProps> = ({ 
  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row items-center sm:items-start justify-center gap-5 md:gap-8 text-center">
        {/* Real Black and White Circular Emblem Logo */}
        <div className="shrink-0 flex items-center justify-center">
          <div className={`w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden shadow-lg bg-black flex items-center justify-center p-0.5 ${
        ...
        <div className="flex flex-col items-center text-center space-y-1.5 flex-1 max-w-2xl">
  ...
  <table style="width: 100%; border-bottom: 2px solid #0f172a; padding-bottom: 16px; margin-bottom: 24px; font-family: Arial, Helvetica, sans-serif; text-align: center;">
    <tr>
      <td style="width: 110px; vertical-align: middle; text-align: center;">
        <img src="${REAL_LOGO_BASE64}" width="88" height="88" alt="Jaystarbliss Logo" style="display: block; margin: 0 auto; border-radius: 50%; filter: grayscale(100%) contrast(140%);" />
      </td>
